...
public class RightControlMixerBehaviour : PlayableBehaviour
{
    ...
    public override void ProcessFrame(Playable playable, FrameData info, object playerData)
    {
        ...
        for (int i = 0; i < inputCount; i++)
        {
            ...
            ScriptPlayable<RightControlBehaviour> inputPlayable = (ScriptPlayable<RightControlBehaviour>)playable.GetInput(i);
            RightControlBehaviour input = inputPlayable.GetBehaviour ();
